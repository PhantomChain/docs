...
If you are not running a relay yourself you can use [https://node1.phantomnet.cloud/peer/](https://node1.phantomnet.cloud/peer/) to test API calls. Happy developing!
...
| version | string | The version of PhantomChain/phantom-node.                 | :white_check_mark: |
