...
<request-example>
```bash
curl -X GET https://explorer.phantom.org:8443/api/peers \
  -H "API-Version: 1"
```
</request-example>
...
<request-example>
```bash
curl -X GET https://explorer.phantom.org:8443/api/peers/get?ip=185.233.104.31&port=4001 \
  -H "API-Version: 1"
```
</request-example>
...
<request-example>
```bash
curl -X GET https://explorer.phantom.org:8443/api/peers/version \
  -H "API-Version: 1"
```
</request-example>
