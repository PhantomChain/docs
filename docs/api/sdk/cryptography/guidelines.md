...
**The following is a guide for implementing a new Phantom Cryptography SDK. It covers the required functionalities as well as guidelines for how cryptography should typically look and behave.**

These guidelines are to be strictly followed if you are implementing or modifying a cryptography package for the PHANTOM.
...
You can check [https://github.com/PhantomChain/php-crypto](https://github.com/PhantomChain/php-crypto) for an example of how this structure looks like when implemented and how it is reflected in the structure of tests.
...
- [https://github.com/PhantomChain/dotnet-crypto](https://github.com/PhantomChain/dotnet-crypto)
- [https://github.com/PhantomChain/php-crypto](https://github.com/PhantomChain/php-crypto)
- [https://github.com/PhantomChain/python-crypto](https://github.com/PhantomChain/python-crypto)
- [https://github.com/PhantomChain/ruby-crypto](https://github.com/PhantomChain/ruby-crypto)

### Functional Programming
- [https://github.com/PhantomChain/elixir-crypto](https://github.com/PhantomChain/elixir-crypto)
- [https://github.com/PhantomChain/go-crypto](https://github.com/PhantomChain/go-crypto)
